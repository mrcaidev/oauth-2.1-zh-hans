...
根据授权服务器的策略或资源所有者的指示，授权服务器**可以**完全或部分忽略客户端所请求的范围。如果颁发的访问令牌的范围与客户端所请求的范围不同，授权服务器**必须**在令牌响应（[第 3.2.3 节](../03-protocol-endpoints/02-token-endpoint.md#323-令牌响应)）中包含范围响应参数，以告知客户端实际授权的范围。
...
为了防止访问令牌的泄露，客户端和资源服务器之间的通信交互**必须**使用[第 1.5 节](05-communication-security.md)中描述的私密性和完整性保护。
