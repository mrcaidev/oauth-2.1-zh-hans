...
使用[附录 B](02-use-of-application-x-www-form-urlencoded-media-type.md) 中定义的 application/x-www-form-urlencoded 格式，把参数和值添加到 HTTP 请求体中，从而序列化参数和值。这种方法通常用于 HTTP POST 请求。
