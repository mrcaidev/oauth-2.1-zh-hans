...
> [!WARNING]
>
> 在编写此 README 文档时，OAuth 2.1 规范仍然处于草案阶段。这意味着本规范——如同它在[文档状态](docs/00-frontmatter.md#文档状态)中所述——“是草稿文档，有效期最长为六个月，并且随时可能被其它文档更新、取缔或废弃”，并且“不宜作为参考文献或引用，除非将其标注为‘半成品’。”
>
> 本项目将紧密跟踪规范[最新版本](https://github.com/oauth-wg/oauth-v2-1/releases/latest)，并及时更新翻译内容，确保译文与原文始终保持内容一致。
